...
```bash
git clone https://colab.research.google.com/github/Motea99/Pneumonia-Diagnosis-System-Challenge/blob/main/MAI_End_To_End_Demo.ipynb
...
**Dr. Motea Alsamawi** Researcher in Medical AI & Biomedical Engineering
